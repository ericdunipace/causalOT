...
#include "stanExports_barycenter_projection.h"

RCPP_MODULE(stan_fit4barycenter_projection_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_barycenter_projection")
