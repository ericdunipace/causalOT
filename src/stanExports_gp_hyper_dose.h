...
namespace model_gp_hyper_dose_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gp_hyper_dose");
    reader.add_event(216, 214, "end", "model_gp_hyper_dose");
    return reader;
}
...
class model_gp_hyper_dose
  : public stan::model::model_base_crtp<model_gp_hyper_dose> {
private:
        int N;
        vector_d y;
        matrix_d discrep;
        ...
        int num_param;
public:
    model_gp_hyper_dose(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_gp_hyper_dose_namespace::model_gp_hyper_dose";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_gp_hyper_dose_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_gp_hyper_dose_namespace::model_gp_hyper_dose stan_model;
#ifndef USING_R
