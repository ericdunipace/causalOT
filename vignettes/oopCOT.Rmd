...
*Note:* the dual optimization method currently available for the `COT` method is not implemented for `OTProblem` objects. Thus, these optimization problems will possibly take longer to solve.
...
overall_ot
#> OT Problem: 
#>   OT(0x7fa3f44ca140, 0x7fa3fa1f2e38) +
#>   OT(0x7fa3f9daf3b8, 0x7fa3fa1f2e38) +
#>   OT(0x7fa40bf40e98, 0x7fa3fa1f2e38) +
#>   OT(0x7fa409a345c8, 0x7fa3fa1f2e38)
```
Neat!
...
#> 
#> $`0x7fa3f28e75f0`$delta
#> [1] 1e-04
#> 
#> 
#> $`0x7fa3e7fb3ba0`
#> $`0x7fa3e7fb3ba0`$balance
#> torch_tensor
#> 0.001 *
#> -3.3433
#>  3.5927
