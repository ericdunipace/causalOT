...
testthat::test_that("optimal weighting works, augmentation", {
  ...
  testthat::expect_equivalent(outcome_model(data, weights = opt_weights_mosek[[4]], doubly.robust = TRUE, target = "ATE"),
                              mean(data$get_tau()), tolerance = 0.1)
  testthat::expect_equivalent(outcome_model(data, weights = opt_weights_gurobi[[4]], doubly.robust = TRUE, target = "ATE"),
                              mean(data$get_tau()),tolerance = 0.1)
  testthat::expect_equivalent(outcome_model(data, weights = opt_weights_cplex[[4]], doubly.robust = TRUE, target = "ATE"),
                              mean(data$get_tau()),tolerance = 0.1)
})
