testthat::test_that("measure forms", {
  ...
  testthat::expect_equal(as.matrix(m_w$x), as.matrix(mcdw$x))
  testthat::expect_equal(as.matrix(m_w$weights), as.matrix(mcdw$weights))
  testthat::expect_true(m_w$requires_grad)
  testthat::expect_true(!mcdw$requires_grad)
  
  m_x <- Measure(x = x, adapt = "x")
  testthat::expect_true(isFALSE(as.logical(m_x$weights$requires_grad)))
  testthat::expect_true(isTRUE(as.logical(m_x$x$requires_grad)))
  testthat::expect_true( is.na(m_x$balance_functions) )
  testthat::expect_true( is.na(m_x$balance_target) )
  testthat::expect_equal(as.numeric(m_x$weights), rep(1.0/100,100))
  ...
  loss <- sum(m_x$x*5)
  loss$backward()
  testthat::expect_true(all(as.logical(m_x$x$grad == 5)))
  ...
  testthat::expect_true(isFALSE(as.logical(m_t$weights$requires_grad)))
  testthat::expect_true(isFALSE(as.logical(m_t$x$requires_grad)))
  ...
  testthat::expect_true(isTRUE(as.logical(m_wt$weights$requires_grad)))
  testthat::expect_true(isFALSE(as.logical(m_wt$x$requires_grad)))
  testthat::expect_equal(ncol(m_wt$balance_functions), ncol(x))
  testthat::expect_true( !all(as.logical(m_wt$balance_functions$isnan()) ))
  ...
  testthat::expect_true(isFALSE(as.logical(m_xt$weights$requires_grad)))
  testthat::expect_true(isTRUE(as.logical(m_xt$x$requires_grad)))
  testthat::expect_equal(ncol(m_xt$balance_functions), ncol(x))
  testthat::expect_true( !all(as.logical(m_xt$balance_functions$isnan()) ))
