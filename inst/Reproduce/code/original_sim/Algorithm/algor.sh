...
mkdir -p TextOutput/algor/${SLURM_ARRAY_JOB_ID}

source activate COT

R CMD BATCH --no-save algorithm_sim.R TextOutput/algor/${SLURM_ARRAY_JOB_ID}/algor_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.txt
